...
![Схема проекта](https://i.ibb.co/vdYp21P/123.png)
...
Записи в базу данных происходят реже, чем чтение из PostgreSQL => Используем синхронную репликацию, т.к. иначе данные могут быть утеряны. То есть данные записываются сначала как минимум в одной реплике бд, а только затем используются в мастере. 
...
Разделение 900 Edge серверов по местоположению в зависимости от регионов:
* Западное США - 15% Edge серверов = 135
* Восточное США - 15% Edge серверов = 135
* Германия - 10% Edge серверов = 90
* Корея - 10% Edge серверов = 90
* Россия - 10% Edge серверов = 90
* Франция - 10% Edge серверов = 90
* Остальные 30% = 270 Edge серевров распределены по всему миру 
